    ...
    return (
        <form action="">
            <div className='grid md:grid-cols-12 gap-5'>
                ...
                <div className='mb-4'>
                    <textarea name="description" className='py-2 px-4 rounded-sm border border-gray-400 w-full'></textarea>
                    <div aria-live='polite' aria-atomic="true">
                        <span className='text-sm text-red-500 mt-2'>message</span>
                    </div>
                </div>
                <div className='mb-4 grid md:grid-cols-3'>
                    <input type='checkbox' name='amenities' className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded'></input>
            ...
            <div className='col-span-4 bg-white p-4'>
                ...
                <button className="bg-orange-400 text-white w-full hover:bg-orange-500 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer">Simpan</button>
            </div>
        </form>
    )
}
